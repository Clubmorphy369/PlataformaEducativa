// ============================================================
//  TAREAS Y ENTREGAS (con editor enriquecido y subida de archivos)
// ============================================================

// Funciones del editor enriquecido
...
function insertIFrame() {
    const code = prompt('Pega el código del iframe (por ejemplo, de YouTube):');
    if (code) {
...
function uploadTaskFile() {
    ...
    if (!file) return;
    const storageRef = storage.ref('tareas/' + Date.now() + '_' + file.name);
    ...
    uploadTask.on('state_changed',
        ...
        async () => {
            ...
            editor.focus();
            const html = `<a href="${url}" target="_blank">📎 ${file.name}</a>`;
        ...
        html += `
            <div class="task-item">
                ...
                <div class="meta">
                    ...
                    <span><i class="fas fa-file-alt"></i> ${task.desc ? 'Con descripción' : 'Sin descripción'}</span>
                </div>
                <div class="actions">
...
document.getElementById('createTaskForm').addEventListener('submit', function(e) {
    ...
    const desc = document.getElementById('taskEditor').innerHTML;
    ...
    document.getElementById('taskEditor').innerHTML = '';
